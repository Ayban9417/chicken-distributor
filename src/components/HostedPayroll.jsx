...
export function HostedPayroll({ organizationId, userId }) {
  ...
  return <div>
    <SectionHeader title="Payroll" eyebrow="Hosted payroll records" action={<div className="flex flex-wrap gap-2"><Button variant="secondary" aria-label="Refresh payroll" onClick={remote.refresh}><RefreshCw size={17} /></Button><Button onClick={() => { setPeriodForm(freshPeriod()); setEntryForm(null); }}><Plus size={17} />Pay Period</Button></div>} />
